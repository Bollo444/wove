        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">Wove</span>
            </div>
            <p className="text-gray-600 mb-6 max-w-md">
              Empowering young minds to create, share, and discover amazing stories. 
              Join our community of storytellers and let your imagination soar.
            </p>
            
            {/* Newsletter Signup */}
            <div className="mb-6">
              <h4 className="text-sm font-semibold text-gray-900 mb-2">Stay Updated</h4>
              <div className="flex max-w-md">
                ...
                />
                <button className="px-4 py-2 bg-purple-600 text-white rounded-r-lg hover:bg-purple-700 transition-colors text-sm font-medium">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
              ...
              <div className="flex items-center space-x-4 text-xs text-gray-400">
                <span>Made with ❤️ for young storytellers</span>
                <span>•</span>
