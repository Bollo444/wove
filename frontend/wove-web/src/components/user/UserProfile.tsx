...
const UserProfile: React.FC<UserProfileProps> = ({ userId }) => {
  ...
  if (!profileUser) {
    return (
      <div className="text-center p-8" data-oid="hi2yh9r">
  ...
  return (
    <div className="max-w-2xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-xl" data-oid="1ltwwy.">
      <div className="flex flex-col items-center md:flex-row md:items-start" data-oid="cwcw5:-">
        <img
        ...
        <div className="text-center md:text-left" data-oid="eok.ov0">
          <h1 className="text-3xl font-bold text-gray-800" data-oid="n9-f4u5">
            {profileUser.displayName}
          </h1>
          <p className="text-md text-gray-600" data-oid="dnsqixv">
            {profileUser.firstName} {profileUser.lastName}
          </p>
          <p className="text-sm text-purple-600" data-oid="vhb13:1">
            {profileUser.email}
          </p>
      ...
      {profileUser.bio && (
        <div className="mt-6 pt-6 border-t border-gray-200" data-oid="0rzm5sn">
          <h2 className="text-xl font-semibold text-gray-700 mb-2" data-oid="acexmor">
            Bio
          </h2>
          <p className="text-gray-600 whitespace-pre-line" data-oid="y6-q5tt">
            {profileUser.bio}
          </p>
        </div>
      )}

      <div className="mt-6 pt-6 border-t border-gray-200" data-oid="bakgvbo">
        <h2 className="text-xl font-semibold text-gray-700 mb-2" data-oid="o6vn1sa">
          Account Details
        </h2>
        <ul className="list-disc list-inside text-gray-600 space-y-1" data-oid="xwv875y">
          <li data-oid="woyb91h">Email Verified: {profileUser.isEmailVerified ? 'Yes' : 'No'}</li>
      ...
      <div className="mt-8 text-center" data-oid="v929hne">
        <button
